...
{
    connect(m_fileSystemWatcher, &QFileSystemWatcher::fileChanged, this, &FileAssociatedShader::fileChanged);
}
...
QOpenGLShader * FileAssociatedShader::getOrCreate(QOpenGLShader::ShaderType type, const QString & fileName, QOpenGLShaderProgram & program)
{
