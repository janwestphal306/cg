...
void Box::initialize(QOpenGLShaderProgram &program)
{
    ...
    for(float y = -heightT; y <= heightT - (m_stepSizes[1] * 0.5f); y += m_stepSizes[1])
    {
        for(float x = -widthT; x <= widthT - (m_stepSizes[0] * 0.5f); x += m_stepSizes[0])
        {
            ...
            vertices.push_back(QVector3D(x, y, depthT));

            normals.push_back(QVector3D(0.0f, 0.0f, 1.0f));
            vertices.push_back(QVector3D(x + m_stepSizes[0], y, depthT));

            normals.push_back(QVector3D(0.0f, 0.0f, 1.0f));
            vertices.push_back(QVector3D(x, y + m_stepSizes[1], depthT));

            normals.push_back(QVector3D(0.0f, 0.0f, 1.0f));
            vertices.push_back(QVector3D(x + m_stepSizes[0], y, depthT));

            normals.push_back(QVector3D(0.0f, 0.0f, 1.0f));
            vertices.push_back(QVector3D(x + m_stepSizes[0], y + m_stepSizes[1], depthT));
    ...
    for(float x = -widthT; x <= widthT - (m_stepSizes[0] * 0.5f); x += m_stepSizes[0])
    {
        for(float z = -depthT; z <= depthT - (m_stepSizes[2] * 0.5f); z += m_stepSizes[2])
        {
            ...
            vertices.push_back(QVector3D(x, heightT, z + m_stepSizes[2]));

            normals.push_back(QVector3D(0.0f, 1.0f, 0.0f));
            vertices.push_back(QVector3D(x + m_stepSizes[0], heightT, z + m_stepSizes[2]));

            normals.push_back(QVector3D(0.0f, 1.0f, 0.0f));
            vertices.push_back(QVector3D(x, heightT, z));

            normals.push_back(QVector3D(0.0f, 1.0f, 0.0f));
            vertices.push_back(QVector3D(x + m_stepSizes[0], heightT, z + m_stepSizes[2]));

            normals.push_back(QVector3D(0.0f, 1.0f, 0.0f));
            vertices.push_back(QVector3D(x + m_stepSizes[0], heightT, z));
    ...
    for(float z = -depthT; z <= depthT - (m_stepSizes[2] * 0.5f); z += m_stepSizes[2])
    {
        for(float y = -heightT; y <= heightT - (m_stepSizes[1] * 0.5f); y += m_stepSizes[1])
        {
            ...
            vertices.push_back(QVector3D(-widthT, y, z));

            normals.push_back(QVector3D(-1.0f, 0.0f, 0.0f));
            vertices.push_back(QVector3D(-widthT, y, z + m_stepSizes[2]));

            normals.push_back(QVector3D(-1.0f, 0.0f, 0.0f));
            vertices.push_back(QVector3D(-widthT, y + m_stepSizes[1], z + m_stepSizes[2]));
            ...
            normals.push_back(QVector3D(-1.0f, 0.0f, 0.0f));
            vertices.push_back(QVector3D(-widthT, y + m_stepSizes[1], z));
